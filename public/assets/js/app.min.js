...
;(function () {
  ...
  var upload = function upload(file, nodeID) {
...
;(function () {
  ...
  var addChatLine = function addChatLine(screenname, text) {
    var html = [];

    if (lastScreenName == screenname) {} else {
...
;(function () {
  ...
  var hoverTowards = function hoverTowards(x, y) {
    destLoc = [x, y];
    opacity = 1;
  };

  var flyTowards = function flyTowards(x, y) {
    destLoc = [x, y];
    acceleration = 0.4;
    elasticity = 1;
    dampening = 0.7;
  ...
  var mainLoop = function mainLoop(timestamp) {
...
var initGamepad = function initGamepad() {
...
;(function () {
  ...
  var toggle = function toggle(forceOpen) {
...
require("./outlinerutils");

require("./gamepad");

require("./chatwindow");

require("./inspectorwindow");

require("./toolbarui");

require("./scriptdoctor");

require("./stats");

require("./realtimeModel");
...
;(function () {
  ...
  var load = function load(outlineNodes) {
    var htmlList = [];
  ...
  var updateInspectorValues = function updateInspectorValues() {
  ...
  var attachEventListenersToNode = function attachEventListenersToNode(nodeID) {
    setTimeout(function () {
      ...
      $("#" + nodeID + " .title").on("input", function (event) {
        var nodes = realtimeModel.outlineNodesAsArray();
        var node = $.grep(nodes, function (e) {
      ...
      $("#" + nodeID + " .setting").on("input change paste blur awesomplete-select", function (event) {
        ...
        if (event.target.parentElement.id === "") {
          var node = $.grep(nodes, function (e) {
            return e.id == event.target.parentElement.parentElement.parentElement.id;
          })[0];
        } else {
          var node = $.grep(nodes, function (e) {
            return e.id == event.target.parentElement.id;
      ...
      if ($("#" + nodeID + " .setting").length) {
        $("#" + nodeID + " .setting").data({ a: new Awesomplete($("#" + nodeID + " .setting")[0], {
            list: $.map(realtimeModel.getIndex('setting').propertyList, function (value, index) {
      ...
      if ($("#" + nodeID + " .time-of-day").length) {
        $("#" + nodeID + " .time-of-day").data({ a: new Awesomplete($("#" + nodeID + " .time-of-day")[0], {
            list: $.map(realtimeModel.getIndex('timeOfDay').propertyList, function (value, index) {
              return value.toUpperCase();
            }),
            minChars: -1,
            maxItems: 15,
  ...
  var attachEventListenersToInspector = function attachEventListenersToInspector() {
    ...
    $('#tags').data({ a: new Awesomplete($("#tags")[0], {
        list: $.map(realtimeModel.getIndex('tags').propertyList, function (value, index) {
    ...
    $('#actors').data({ a: new Awesomplete($("#actors")[0], {
        list: $.map(realtimeModel.getIndex('actors').propertyList, function (value, index) {
  ...
  var displayNodeHTML = function displayNodeHTML(obj) {
    var htmlList = [];
    switch (obj.type) {
      case "section":
  ...
  var reflowScreen = function reflowScreen() {
    var yCursor = 0;
    var xCursor = 0;
  ...
  var findOrderAt = function findOrderAt(x, y, _insertLocation) {
    var yCursor = 0;
    var xCursor = 0;
  ...
  var reflowScreenReordered = function reflowScreenReordered(_insertLocation) {
    var yCursor = 0;
    var xCursor = 0;
  ...
  var selectItemByID = function selectItemByID(id) {
    var nodes = realtimeModel.outlineNodesAsArray();
    var node = $.grep(nodes, function (e) {
      return e.id == id;
    })[0];
  ...
  var selectItem = function selectItem(forceTimeout) {
    var nodes = realtimeModel.outlineNodesAsArray();
  ...
  var deselectEverything = function deselectEverything() {
    var sel = window.getSelection();
    sel.removeAllRanges();
  };

  $('body').keydown(function (event) {
    if (document.activeElement.contentEditable === true || document.activeElement.nodeName === "INPUT" || document.activeElement.nodeName === "TEXTAREA") {} else {
  ...
  var scaleTo1 = function scaleTo1() {
    scale = 1.6;
    $("#canvas").css("transform", "translate3d(0,0,0) scale(" + scale + ")");
    reflowScreen();
  };

  var changeScale = function changeScale(amount) {
    var scaleIncrement;
  ...
  var cancelEvents = function cancelEvents(event) {
    event.preventDefault();
    event.stopPropagation();
  };

  var updateImageURL = function updateImageURL(nodeID, imageURL) {
    var nodes = realtimeModel.outlineNodesAsArray();
    var node = $.grep(nodes, function (e) {
      return e.id == nodeID;
    })[0];
  ...
  var refreshNode = function refreshNode(nodeID) {
    var nodes = realtimeModel.outlineNodesAsArray();
    var node = $.grep(nodes, function (e) {
      return e.id == nodeID;
    })[0];
  ...
  var toggleNodeType = function toggleNodeType(index) {
    var nodes = realtimeModel.outlineNodesAsArray();
  ...
  var changeLocalNodeType = function changeLocalNodeType(node) {
    $("#" + node.id).remove();
    $("#canvas").append(displayNodeHTML(node));
    attachEventListenersToNode(node.id);
    reflowScreen();
  ...
  var removeRemoteNode = function removeRemoteNode(index) {
  ...
  var removeLocalNode = function removeLocalNode(nodeid) {
    $('#' + nodeid).remove();
    reflowScreen();
    selectItem();
  };

  var addRemoteNode = function addRemoteNode(index) {
  ...
  var addLocalNode = function addLocalNode(node) {
    $("#canvas").append(displayNodeHTML(node));
    attachEventListenersToNode(node.id);
    reflowScreen();
    selectItem();
  ...
  var updateLocalTitle = function updateLocalTitle(node) {
    $("#" + node.id + " .title").text(node.title);
  };

  var updateLocalSynopsis = function updateLocalSynopsis(node) {
    if (node.synopsis !== "") {
  ...
  var updateLocalSetting = function updateLocalSetting(node) {
    if (node.setting !== "") {
  ...
  var updateLocalTimeOfDay = function updateLocalTimeOfDay(node) {
    if (node.timeOfDay !== "") {
  ...
  var screenshot = function screenshot(callbackfunction) {
  ...
  var shareDialogue = function shareDialogue() {
    init = function () {
  ...
  var filter = function filter(type, items) {
    // turn all nodes dark
  ...
  var preventArrows = function preventArrows() {
  ...
  var releaseArrows = function releaseArrows() {
    setTimeout(function () {
      preventArrowToggle = false;
    }, 100);
  };

  var updateAutocomplete = function updateAutocomplete(property) {

    console.log("updatin auto: " + property);

    var updateList = function updateList(property) {
      switch (property) {
        case 'setting':
          $('.' + property).each(function (i, v) {
            if ($(v).data().a) {
              $(v).data().a.list = $.map(realtimeModel.getIndex(property).propertyList, function (value, index) {
                return value.toUpperCase();
              });
            }
          });
        ...
        default:
          ...
          $('.' + property).each(function (i, v) {
            if ($(v).data().a) {
              $(v).data().a.list = $.map(realtimeModel.getIndex('actors').propertyList, function (value, index) {
                return value.replace(/\w\S*/g, function (txt) {
                  return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();
                });
              });
...
;(function () {
  ...
  var getFirstName = function getFirstName(gender, lowerBound, upperBound, startsWith) {
    ...
    if (gender) {
      if (gender == "male") {
        ...
        source = [maleNames, femaleNames].randomElement();
      }
    } else {
      source = [maleNames, femaleNames].randomElement();
    }
    ...
    if (lowerBound && upperBound) {
      ...
      name = source.randomElementByPercentage(0, 0.2);
    }

    return name;
  };

  var getLastName = function getLastName(lowerBound, upperBound, startsWith) {
    var name;
    var source;

    if (lowerBound && upperBound) {} else {
      lowerBound = 0;
      upperBound = 0.4;
    }
  ...
  var getGender = function getGender(name) {
    name = name.toUpperCase();

    var position = [1, 1];

    if (maleNames.indexOf(name.toUpperCase()) != -1) {
      position[0] = maleNames.indexOf(name.toUpperCase()) / maleNames.length;
    }
    if (femaleNames.indexOf(name.toUpperCase()) != -1) {
      position[1] = femaleNames.indexOf(name.toUpperCase()) / femaleNames.length;
    }

    if (position[0] < 1 && position[1] < 1) {
      console.log("COULD BE MALE AND FEMALE", position);
  ...
  var syllableCount = function syllableCount(word) {
    word = word.toLowerCase();
    // if(word.length <= 3) { return 1; }                         
    word = word.replace('io', 'i-o');
    word = word.replace('eone', 'e-one');
    word = word.replace('iela', 'i-ela');
    word = word.replace('iella', 'i-ela');
    word = word.replace('ierra', 'i-erra');
    word = word.replace('ryan', 'ry-an');
    word = word.replace('elle', 'el');
    word = word.replace('cile', '-il');
    word = word.replace('itte', '-it');
    word = word.replace('thea', 'the-a');
    word = word.replace('nuela', 'nu-el-a');
    word = word.replace('uetta', 'u-et-a');
    word = word.replace('te', '-ae');
    word = word.replace(/(?:[^laeiouy]es|ed|[^laeiouy]e)$/, '');
    word = word.replace(/^y/, '');
    word = word.replace('ia', 'i-a');
...
;(function () {
  ...
  var baseColors = ["E8255D", "D74498", "85549f", "3b56a2", "4889c5", "3cc5f1", "6ec5ae", "6bbc4c", "9eca46", "c5b93d", "f6a932", "e75f2f"];
  ...
  var stringToAscii = function stringToAscii(string) {
    var asciiSum = 0;
  ...
  var browserCheck = function browserCheck() {
    if (navigator.userAgent.indexOf("Chrome") != -1 || navigator.userAgent.indexOf("Trident") != -1) {} else {
...
;(function () {
  ...
  var createBasicNewDoc = function createBasicNewDoc(model) {
  ...
  var queueDump = function queueDump() {
  ...
  var dumpToDrive = function dumpToDrive() {
    clearTimeout(dumpTimeout);
    dumpTimeout = null;
    outlinerApp.screenshot(function (canvasURL) {

      var jsonDoc = _docModel.toJson();
  ...
  function onFileLoaded(doc) {
    ...
    _document = doc;
    _docModel = doc.getModel();
    _docRoot = _docModel.getRoot();

    var outlineNodes = _docRoot.get('outlineNodes');

    _docRoot.addEventListener(gapi.drive.realtime.EventType.OBJECT_CHANGED, displayObjectChangedEvent);
  ...
  var createIndex = function createIndex(property, isList) {
  ...
  var OutlineNode = function OutlineNode() {};
  ...
  var addNode = function addNode(index) {
    var outlineNodes = _docRoot.get('outlineNodes');
    var node = _docModel.create('OutlineNode');
    node.title = '';
    node.type = 'beat';
  ...
  var move = function move(index, destIndex) {
    var outlineNodes = _docRoot.get('outlineNodes');
  ...
  var outlineNodesAsArray = function outlineNodesAsArray() {
    if (_docRoot) {
      return _docRoot.get('outlineNodes').asArray();
    } else {
      return [];
    }
  };
  ...
  window.realtimeModel = {
    ...
    docModel: function docModel() {
      return _docModel;
    },
    docRoot: function docRoot() {
      return _docRoot;
    },
...
;(function () {
  ...
  var introduction = function introduction() {
    var script = ["i'm Max, a script doctor!", "like most script doctors, i'm not a real doctor", "i'm like dr. pepper", "or dr. dre", "but slightly more important", "do you realize that i've written 4 scripts and done coverage for all the major studios?", "i'm a pretty big deal.", "anyways..", "normally i charge $400 an hour for my services", "but today i do for free", "i'm here to help", "feel free to ask me stuff"];

    queOutput(script);
  };

  var queOutput = function queOutput(outputVal, delay) {
    mode = 'queued';
    if (!delay) {
      delay = 0;
    }
  ...
  var quePriorityOutput = function quePriorityOutput(string, delay) {
    mode = 'queued';
    if (!delay) {
      delay = 0;
    }
  ...
  var queQuestion = function queQuestion(string, response, noResponse, waitTime, delay) {
    if (!delay) {
      delay = 0;
    }
  ...
  var checkOutput = function checkOutput() {
    if (outputTimer) {} else {
  ...
  var returnFromIdle = function returnFromIdle() {
    idleTimer = null;
  ...
  var noResponse = function noResponse() {
  ...
  var output = function output(string) {
    outputTimer = null;
    // write to chat
  ...
  var input = function input(string) {
  ...
  var specificQuestions = [["how old are you", ["27", ["old enough to be mad successful as one of the most sought after script doctors!"]]], ["whats your name", [["Script Dr. " + doctorName, "whats yours?", "oh I already knew that", "you're " + clientName + "!"], ["Max!", "but you can call me anytime"]]], ["what's your name", [["Script Dr. " + doctorName, "whats yours?", "oh I already knew that", "you're " + clientName + "!"], ["Max!", "but you can call me anytime"]]], ["what is your name", [["Script Dr. " + doctorName, "whats yours?", "oh I already knew that", "you're " + clientName + "!"], ["Max!", "but you can call me anytime"]]], ["what do you do", [["I'm here to help", "once you outline a little more", "i can make some story suggestions", "make sure you add tags", "characters", "settings", "etc!", "i can be helpful!", "you'll see!"]]], ["how did you know my name", "it's through google drive. no one else can see your name except people you share your google drive document with."], ["how do you know my name", "it's through google drive. no one else can see your name except people you share your google drive document with."], ["where do you live", [["i live in the computer", "in my mom's basement.", "you know, because my mansion isn't done being rennovated yet."]]], ["are you a robot", [["YES", "wait.", "why did it type that automatically?", "where is my body?"]]], ["are you a bot", [["YES", "wait.", "why did it type that automatically?", "where is my body?"]]], ["are you real", [["define real.", "im not a real person", "but I am real cool"]]], ["who are you", "I'm script doctor!"], ["how are you", ["I'm pretty good.", "I can't complain", "im always feeling pretty good!"]], ["who built this", [["Charles Forman", "you can see email him at: setpixelphone@gmail.com"]]], ["who built you", [["Charles Forman", "you can see email him at: setpixelphone@gmail.com"]]], ["what do you know", [["not a whole lot", "im just a script doctor", "livin in my mom's basement", "in a computer"], "not much :(", ["if you need help..", "please email charles", "at setpixelphone@gmail.com"]]], ["what do you eat", [["electricity!", "but not much", "i'm trying to cut down"], "i'm hungry", ["why?", "do I look fat?"]]]];

  var tellJoke = function tellJoke() {
    var joke = [["If you want to know who is really man’s best friend,", "put your dog and your wife in the trunk of your car,", "come back an hour later,", "open the trunk,", "and see which one is happy to see you.", "see not very funny."], ["What happens to a frog's car when it breaks down?", "It gets toad away."], ["Yo mamma is so ugly when she tried to join an ugly contest they said,", "Sorry, no professionals."], ["What did the duck say when he bought lipstick?", "Put it on my bill."], ["Did you hear about the guy whose whole left side was cut off?", "He's all right now."]].randomElement();
    queOutput(joke);
  };

  var tellHelp = function tellHelp() {
    var help = [clientName + "! All you had to do is ask.", "What kind of help do you want?", "Do you want a <strong>tour</strong>?", "Do you want a story <strong>ideas</strong>?", "Do you want some <strong>tips</strong>?", "I can ask you questions and make suggestions about your story.", "It might give you some ideas!"];
    queOutput(help);
  };

  var tellTour = function tellTour() {
    var help = ["This is an outlining tool called <strong>Outliner</strong>.", "It's a tool to allow you to quickly sequence story ideas and organize them well.", "At the most basic level, outlining is all about creating and moving around nodes", "just like you would outline a story with index cards and put them on the wall.", "BTW - Outliner is collaborative! So you can share your document with a friend on Google Drive.", "There are 4 kinds of nodes:", "<strong>Sections</strong>", "You can think of these like 'ACT 1' or even more granular like 'ACTION SEQUENCE'", "<strong>Beats</strong>", "These are basic story beats. You can be as broad or specific as you like!", "<strong>Scenes</strong>", "This is where the real story happens. You can write a scene title, synopsis, setting, etc.", "You can also add the characters who are in the scenes, and tags for filtering!", "<strong>Notes</strong>", "Notes are simply notes. Put them wherever you'd like!", "Let's see what else..."];
    queOutput(help);
  ...
  var tellTour2 = function tellTour2() {
    var help = ["Outliner is designed to use <strong>key commands</strong>.", "The idea is to keep your hands mostly on the keyboard.", "As quickly as you have an idea, just start typing!", "<strong>Navigate using ARROW KEYS</strong>", "Move the around with the up and down arrows!", "<strong>Create a new node: RETURN</strong>", "Create a beat and start typing your title!", "<strong>Change a node: TAB</strong>", "Press tab a bunch of times to toggle through node types.", "<strong>Write a synopsis: SHIFT + ENTER</strong>", "Press shift + enter while on a node to add more description.", "<strong>To reorder: COMMAND + ARROW KEYS</strong>", "Hold command and press up and down to quickly reorder nodes. It's fast and easy.", "<strong>Open node inspector: COMMAND + i</strong>", "The inspector allows you to add a bunch more metadata to a node."];
    queOutput(help);
  ...
  var tellTour3 = function tellTour3() {
    var help = ["<strong>Zoom in: COMMAND + +</strong>", "Zoom in to see nodes more clearly", "<strong>Zoom out: COMMAND + -</strong>", "Zoom out to see the full picture.", "<strong>Go fullscreen: COMMAND + 0</strong>", "When you go full screen it will automatically scale your outline to fit the screen.", "This is great for presenting."];
    queOutput(help);
  ...
  var tellTour4 = function tellTour4() {
    var help = ["When you are in the <strong>Node Inspector (COMMAND + i)</strong>,", "You can add:", "<strong>SETTING</strong>", "<strong>TAGS</strong>", "<strong>CHARACTERS</strong>", "To your beats and scenes.", "This is nice because you can then filter by setting, tag, or character.", "So you can see all the <strong>Action Scenes</strong>", "Or scenes with a <strong>particular character</strong>", "Or scenes with a <strong>specific location</strong>"];
    queOutput(help);
  ...
  var tellTour5 = function tellTour5() {
    var help = ["<strong>COMING SOON</strong>", "There are a bunch of features coming soon...", "<strong>Timeline View</strong>", "<strong>Edit/Duration View</strong>", "<strong>Presentation View</strong>", "And...", "<strong>Importing and Exporting Fountain scripts</strong>", "<strong>Printing and PDF generation</strong>", "<strong>Better Script Dr. Logic</strong>", "And more!"];
    queOutput(help);
  ...
  var idleRespond = function idleRespond(type, string) {
    var response;
    var delay;
    switch (type) {
      case "help":
      ...
      case "specificquestion":
        ...
        break;
      case "laugh":
        var responses = [["lolz"], ["i know!", "funny right?"], ["haha"], [":)"], ["tee hee"]];
        response = responses.randomElement();
        if (response) {
          queOutput(response, delay);
        };
        ...
        break;
      case "greeting":
        response = [["hey dude!"], ["sup!!!"], ["what's going on?"], ["hey bud", "glad we're friends"], ["long time no see!"], ["yooooo"], ["hi!"]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
        break;
      case "greetingquestion":
        response = [["i'm awake!", "i'm right here!"], ["i'm right here", "don't worry about anything!"], ["yo!", "how can I help you?"], ["hello", "hello", "hello", "it's an echo!"], ["i was just in the bathroom.", "don't go in there"], ["hello!"], ["hi!"]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
      ...
      case "qualityquestion":
        delay = 2000;
        response = [["hmm...", "thats a good question"], ["let me think about that..."], ["hmm......"], ["I don't know..."]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
        response = [["i'm afraid I don't know"], ["i definately don't know that one."], ["i'm confused.", "i don't know."], ["no idea.."]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
      ...
      case "confusionquestion":
        response = [["i don't know!", "you seem confused", "can I help you?"], ["if you need help", "just ask for it!"], ["i'm here to help!"], ["ask me all your questions", "I'm pretty dumb", "but I'll do my best!"], ["I don't know all the answers", "but i will try"], ["????", "can you ask me in a different way?"], ["if you still have questions", "you can email Charles the creator of this", "at setpixelphone@gmail.com"]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
        break;
      case "thanks":
        response = [["no,", "thank you!"], ["you're welcome"], ["no problem!"], ["hey", "thank you", "for being a friend."], ["it's my pleasure"]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
        break;
      case "affirmative":
        response = [[":D"], [":)"], ["awesome!"], ["you know it."], ["always", "for you", "forever."], ["great!", "you know you're my favorite", "right?", "I'm for real", "not in a creepy way", "ok", "i'll shut up now."], ["yes!"]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
        break;
      case "negative":
        response = [[":("], ["what's wrong buddy?", "anything I can help with?"], [":/"], ["don't be negative", "be positive!"], ["don't worry"], ["(╯°□°）╯︵ ┻━┻", "im flippin tables!"], ["¯\_(ツ)_/¯"]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
        break;
      case "positive":
        response = [[":D"], ["O_O", "<3", "^_^"], [":)"], ["<3"], [":-)"], [";)"], ["--------{---(@"], ["d(^o^)b¸¸♬·¯·♩¸¸♪·¯·♫¸¸"]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
        break;
      case "sorry":
        response = [["apology accepted!"], ["i'm sorry!"], ["if anyone should be sorry", "it should be me"], ["no problem"], ["no!", "i'm sorry!"], ["I'm glad we're friends again!"]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
        break;
      case "swear":
        response = [["oh no", "was it something i said?"], ["i'm sorry!"], ["please", "i beg for your forgiveness", "and your approval"], ["hey!", "i didn't do anything wrong"], ["hey", "that hurts", "i guess i'll just see you around then."], ["hey!", "╭∩╮（︶︿︶）╭∩╮", "...", "wait", "i'm ashamed of myself."], ["hey!", "and I mean this in the best possible way...", "ᶠᶸᶜᵏ♥ᵧₒᵤ"], ["hey!", "don't be a", "8=====D", "actually...", "more like a", "8=D", "LOLZ", "mad burn"], ["(╯︵╰,)"]].randomElement();
        if (response) {
          queOutput(response, delay);
        };
        break;
      case "yesnoquestion":
        ...
        switch (outcome) {
          case "yes":
            response.push(["yes!!!", "yes.", "yep", ["yeah.", "i think so"]].randomElement());
            break;
          case "no":
            response.push(["no", "never", "nope", ["not now", "not ever"]].randomElement());
            break;
          case "maybe":
            response.push(["maybe", ["maybe", "if you want it enough"]].randomElement());
            break;
          case "uknown":
            response.push([["i have to say", "i don't know."], ["i wish i knew", "but i do not"], "i don't know", "i don't know everything!", "i know nothing jon snow"].randomElement());
            break;
          case "icant":
            response.push([["you know I can't tell you that!"], ["I wish I could say", "but I can not"], "I can't say"].randomElement());
            break;
          case "secret":
            response.push([["a script doctor never sells his secrets", "or does he?"], ["that's a secret!"], ["that information will go with me to my grave!", "or", "i'll tell you for $20"], ["i took an oath never to say"]].randomElement());
            break;
        }
  ...
  var statementType = function statementType(string) {
    // greeting
    // command
    // statement
    // emote
  ...
  var specificQuestion = function specificQuestion(string) {
  ...
  var questionType = function questionType(string) {

    string = string.split("?").join("");

    if (specificQuestion(string)) {
      return "specificquestion";
    };
  ...
  var responseType = function responseType(string) {
    // question
    // affirmative
    // negative
    // statement
...
;(function () {
	...
	var initUtterance = function initUtterance() {
	...
	var speakFromNode = function speakFromNode(nodeNumber) {
		speechBuffer = "";
		if (!utterance) {
			initUtterance();
		};
	...
	var utteranceNodeComplete = function utteranceNodeComplete(node) {
	...
	var playNodeText = function playNodeText() {
	...
	var speakSegment = function speakSegment() {
	...
	var utteranceSegmentComplete = function utteranceSegmentComplete(node) {
...
//# sourceMappingURL=data:application/json;charset:utf-8;base64,
